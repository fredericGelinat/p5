...
//  const inpAdr = document.querySelector('#adresse');
...
//       const order = {
//         contact: {
//         utilisateur: inpUtilisateur.value,
//                 mail: inpMail.value,
...
// // }else{// Si le formulaire est valide, le tableau productsBought contiendra un tableau d'objet qui sont les produits acheté, et order contiendra ce tableau ainsi que l'objet qui contient les infos de l'acheteur
// //   let productsBought = [];
// //   productsBought.push(copyOfLS);
